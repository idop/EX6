...
namespace Ex06_UI
{
    public class GameManager
    {
        ...
        {
            GameBoard.eBoardSquare playerSquare = m_TurnNumber % 2 == 0
                ? GameBoard.eBoardSquare.Player1Square
                : GameBoard.eBoardSquare.Player2Square;
            --i_NextMove;
            m_TurnNumber++;
            return new PlayerMove(
                m_GameBoard.SetColumnSquare(i_NextMove, playerSquare),
                i_NextMove,
                m_GameBoard.BoardStatus);
        }
        ...
        {
            get { return m_GameBoard.FourInARowWiningPath; }
        }
    }
}